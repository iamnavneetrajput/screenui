...
export function VariantCheckboxDemo() {
...
export function SizeCheckboxDemo() {
...
export function RoundedCheckboxDemo() {
...
export function SpecialStateCheckboxDemo() {
  ...
  return (
    <div className="space-y-8">
      <CheckboxWithLabel
        ...
        onChange={setIndeterminate} // fully supports "indeterminate"
      />
...
export function SelectAllCheckboxDemo() {
