          ...
          <ThemeProvider>
            ...
            <div className="pointer-events-none fixed inset-0 z-50 hidden md:block">
              <div className="custom-container mx-auto h-full relative">
                <div className="absolute top-0 bottom-0 left-0 w-px border-l border-dashed border-border" />
                <div className="absolute top-0 bottom-0 right-0 w-px border-l border-dashed border-border" />
              </div>
            </div>
