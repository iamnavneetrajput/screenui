...
export default function ThemeSection({
  ...
  return (
    <div className="border-b border-dotted border-[var(--color-border)] p-1">
      <div className="flex justify-between items-center bg-[var(--color-background)] p-2 rounded-lg">
